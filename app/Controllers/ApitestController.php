...
///recipe
 ...
 header('Access-Control-Allow-Headers: token, Content-Type');
        ...
        public function profileRecipeInsertComment(){
 header('Access-Control-Allow-Origin: *');
 header('Access-Control-Allow-Methods: POST, GET, DELETE, PUT, PATCH, OPTIONS');
 header('Access-Control-Allow-Headers: token, Content-Type');
    ...
    public function profileRecipeShowAllComment(){
    header('Access-Control-Allow-Origin: *');
    header('Access-Control-Allow-Methods: POST, GET, DELETE, PUT, PATCH, OPTIONS');
    header('Access-Control-Allow-Headers: token, Content-Type');
    $post_id = $this->request->getVar('post_id');
...
// profile event
 ...
 header('Access-Control-Allow-Headers: token, Content-Type');
       ...
       $id = $this->request->getVar('user_id');
        ...
        $users = new UserModel();
        $result["responce"] = true; 
        $result['people_you_may_know']=$users->getSingleUserFriend($id);
 ...
 header('Access-Control-Allow-Headers: token, Content-Type');
       ...
       //$id = $this->request->getVar('user_id');
        ...
        $result["responce"] = true; 
        $result['recommendationRestudent']=$rm->recommendationRestutent();
