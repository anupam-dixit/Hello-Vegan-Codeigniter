		 ...
		 <div class="col-xs-12">
          ...
          <th>Title</th>
				  ...
				  <tr>
				    ...
				    <a href="<?php echo base_url();?>/admin/post/edit/<?php echo $val['id'];?>"  class="btn btn-warning btn-xs" >
					Edit
					</a>
					 <a href="<?php echo base_url();?>/admin/post/view/<?php echo $val['id'];?>"  class="btn btn-info btn-xs">
					View
					</a>
					<a  href="#" class="btn btn-danger btn-xs" target="_blank" data-toggle="modal" data-target="#modal-danger<?php echo $i;?>">
					Delete
					</a>
				     <a href="<?php echo base_url();?>/admin/post/manage-comments/<?php echo $val['id'];?>"  class="btn btn-primary btn-xs">
					Manage Comments
					</a>
					</td>
				  </tr>
