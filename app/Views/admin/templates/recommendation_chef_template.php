...
function delete_product_category(baseurl,ids){
$.ajax({
    url : baseurl+"admin/recommendation/delete-product-category/"+ids,
    type: "GET",
    data : { },
...
function delete_product(baseurl,ids){
$.ajax({
    url : baseurl+"admin/recommendation/delete-product/"+ids,
    type: "GET",
    data : { },
    success: function(data)
    {
...
var baseUrl="https://hello-vegans.com/admin/change-reproduct-status";
...
<script>
var baseUrl="<?php echo base_url('admin/change-reproduct-status'); ?>";
$('input[data-toggle]').on('change', function (event, state) {
