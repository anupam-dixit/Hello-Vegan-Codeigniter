...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/xdan/autocomplete@1.2.8/jquery.autocomplete.css">
...
<script src="https://cdn.jsdelivr.net/gh/xdan/autocomplete@1.2.8/jquery.autocomplete.js"></script>
...
$.ajax({
    url : baseurl+"admin/event/delete-category/"+ids,
    type: "GET",
    data : { },
...
<script>
var baseUrl="<?php echo base_url('admin/change-event-status'); ?>";
