...
$.ajax({
    url : baseurl+"admin/recommendation/delete-category/"+ids,
    type: "GET",
    data : { },
...
function delete_users(baseurl,ids){
$.ajax({
    url : baseurl+"admin/recommendation/delete-users/"+ids,
    type: "GET",
    data : { },
    success: function(data)
    {
...
function delete_plan(baseurl,ids){
$.ajax({
    url : baseurl+"admin/recommendation/plans/delete-plan/"+ids,
    type: "GET",
    data : { },
    success: function(data)
    {
...
function delete_restaurant_features(baseurl,ids){
$.ajax({
    url : baseurl+"admin/recommendation/restaurant/delete-restaurant-feature/"+ids,
    type: "GET",
    data : { },
    success: function(data)
    {
...
<script>
var baseUrl="<?php echo base_url('admin/change-rerequest-status'); ?>";
