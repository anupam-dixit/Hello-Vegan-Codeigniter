...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/event/category"><i class="fa fa-dashboard"></i> Category</a></li>
 ...
 <div class="box box-default">
  <div class="box-header">
   <h3 class="box-title"></h3>
    ...
    <form action="<?php echo base_url('admin/event/update-category');?>" method="post" enctype="multipart/form-data">		  
 	   <div class="box-body">
	    <?php 
		$name=$event_cats['name'];
	  ...
	  <?php endif;?>
           <div class="form-group">
             ...
             <div class="col-sm-3">
			  ...
			  <input type="hidden" id="id" name="id" value="<?php echo $event_cats['id'];?>">
			 </div>
            <div class="col-sm-6">
