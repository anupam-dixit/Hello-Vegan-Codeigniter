...
<div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/tutorials/posts"><i class="fa fa-dashboard"></i> Posts</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
          <form action="<?php echo base_url('admin/tutorials/update-post');?>" method="post" enctype="multipart/form-data">
			 ...
			 <div class="col-md-6">
			  ...
			  <label>Image</label>
                <div class="custom-file">
                 <input type="file" onchange="return valueonchange(this.id)" class="custom-file-input" name="file" id="profile_image">
                 
				 <span style="display:none;color:red" id="error_profile_image">Please select  image</span>
				 <br>
				 <?php if($posts['file']!=''){
					 ?>
				<img src="<?php echo base_url();?>/<?php echo $posts['file'];?>" width="100" height="100">	 
					 <?php
				 }?>
                </div>
              </div>
