<?php echo  $this->extend('admin/templates/tutorials_template'); ?>
		 ...
		 <div class="col-xs-12">
          ...
          <th>Title</th>
				  ...
				  <tr>
					...
					if($val['file']!=''){
					?>
					<img src="<?php echo base_url();?>/<?php echo $val['file'];?>" width="70" height="70">
					<?php 
					}
					?>
					</td>
          <td><?php echo $val['content'];?></td>      
				    ...
				    <a href="<?php echo base_url();?>/admin/tutorials/edit-post/<?php echo $val['id'];?>"  class="btn btn-warning btn-xs" >
					Edit
					</a>
					 <a href="<?php echo base_url();?>/admin/tutorials/view-post/<?php echo $val['id'];?>"  class="btn btn-info btn-xs">
					View
					</a>
