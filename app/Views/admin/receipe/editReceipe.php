...
<div class="content-wrapper">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/receipe/list"><i class="fa fa-dashboard"></i> Receipe</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header">
            <h3 class="box-title">Edit Receipe</h3>
          </div>
          <!-- /.box-header -->
          <form action="<?php echo base_url('admin/receipe/update');?>" method="post" enctype="multipart/form-data">
		  <input type="hidden" name="id" id="id" value="<?php echo $receipes['id'];?>">
		  <div class="box-body">
           	 <div class="row">
			 <div class="col-sm-6">
                      <!-- text input -->
                ...
                <select name="post_category_id" class="form-control select2" style="width: 100%;">
				  ...
				  foreach($categories as $val){
					  $selected='';
					  if($receipes['receipe_category_id']==$val['id']){
						  $selected='selected';
					  }
			      ?>
				  <option  
			...
			<div class="col-sm-6">
				<div class="form-group">
                    ...
                    <input type="text"  id="pac-input" name="location" class="form-control" value="<?php echo $receipes['location'];?>" placeholder="Enter a location">
				</div>
			</div>
            <div class="col-sm-6">			
			...
			<div class="col-sm-12">
						  ...
						  <div class="form-group">
							...
							name="content" rows="3" placeholder="Enter ..."><?php echo $receipes['content'];?></textarea>
						  </div>
				</div>
			 ...
			 <div class="col-md-6">
			  ...
			  <label>Image</label>
                <div class="custom-file">
				 ...
				 <br>
				 <?php if($receipes['image']!=''){
					 ?>
				<img src="<?php echo base_url();?>/<?php echo $receipes['image'];?>" width="100" height="100">	 
					 <?php
				 }?>
                </div>
              </div>
...
<?php
 ...
 ?>
  ...
  var geocoder;
  var map;
  var address ="<?php echo $receipes['location'];?>";
