    ...
    <section class="content">
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
           ...
           <form action="<?php echo base_url('admin/news/insert-post');?>" method="post" enctype="multipart/form-data">
<div class="box-body">		   
 		  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
			...
			<div class="col-sm-12">
			 <div class="col-md-6">
			  <div class="form-group"> 
			  <label><input type="radio" name="videoupload" id="byfile" onclick="selectvideoprocess('videotext','videofile')" checked style="margin-right:5px;">Upload Video </label>
                <div class="custom-file">
			 ...
			 <div class="col-md-6">
			  <div class="form-group"> 
			  <label><input type="radio" id="bytext" name="videoupload" onclick="selectvideoprocess('videofile','videotext')" style="margin-right:5px;"> Or Add Video (By URL)</label>
                <div class="custom-file" id="bytext" >
                 <input type="text" disabled   class="form-control pac-target-input" name="videourl" id="videotext">
...
function selectvideoprocess(id1,id2){
