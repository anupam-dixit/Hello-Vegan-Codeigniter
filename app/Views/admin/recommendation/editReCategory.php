...
<section class="content-header">
      <h1>
         Edit Recommendation Category
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/recommendation/category"><i class="fa fa-dashboard"></i> Category</a></li>
 ...
 <div class="box box-default">
  <div class="box-header">
   <h3 class="box-title"></h3>
    ...
    <form action="<?php echo base_url('admin/recommendation/update-category');?>" method="post" enctype="multipart/form-data">		  
 	   <div class="box-body">
	    <?php 
		$name=$recats['name'];
