...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/recommendation/chef-category"><i class="fa fa-dashboard"></i> Categories</a></li>
 ...
 <div class="box box-default">
  <div class="box-header">
   <h3 class="box-title"></h3>
    ...
    <form action="<?php echo base_url('admin/recommendation/insert-chef-category');?>" method="post" enctype="multipart/form-data">		  
 	   <div class="box-body">
	    <?php 
		$name='';
