                ...
                <table id="example2" class="table table-bordered table-striped">
				  ...
				  <tr>
                   ...
                   <td>
				    ...
				    <a href="<?php echo base_url();?>/admin/recommendation/edit-product/<?php echo $val['id'];?>"  class="btn btn-warning btn-xs" >
					Edit
					</a>
				    ...
				    <a href="<?php echo base_url();?>/admin/recommendation/view-product/<?php echo $val['id'];?>"  class="btn btn-info btn-xs">
					View
					</a>
					</td>
				  </tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="width: 365px;">
                ...
                <button type="button" class="btn btn-primary" onclick="return delete_product('<?php echo site_url();?>','<?php echo $val['id'];?>');">Yes</button>
