              ...
              <div class="box-body">
                <table id="example2" class="table table-bordered table-striped">
				  ...
				  <tr>
				    ...
				    <a href="<?php echo base_url();?>/admin/recommendation/restaurant/edit-category/<?php echo $val['id'];?>"  class="btn btn-warning btn-xs" >
					Edit
					</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer" style="width: 365px;">
                ...
                <button type="button" class="btn btn-primary" onclick="return delete_category('<?php echo site_url();?>','<?php echo $val['id'];?>');">Yes</button>
