...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Restaurant Features</li>
      </ol>
    </section>
 ...
 <div class="box box-default">
  <div class="box-header">
   <h3 class="box-title"></h3>
    ...
    <form action="<?php echo base_url('/admin/recommendation/restaurant/update-restaurant-feature');?>" method="post" enctype="multipart/form-data">		
	  ...
	  <?php endif;?>
		  ...
		  <div class="form-group">
             <label>Features  Name</label>
              <input type="text"  id="name" name="name" class="form-control" placeholder="Name" value="<?php echo $refeatures[0]['name'];?>">
			</div>
		   </div>
		    <div class="col-sm-4">
		    <div class="form-group">
			<label>Image</label>
			  ...
			  <?php 
			  if($refeatures[0]['svgData']!=''){
				  ?>
				 <img src="<?php echo base_url()."/".$refeatures[0]['svgData'];?>" height="100" width="100"> 
				  <?php
			  }
			  ?>
			</div>
