                ...
                <table id="example2" class="table table-bordered table-striped">
				  ...
				  <tr>
                   ...
                   <td>
				    ...
				    <a href="<?php echo base_url();?>/admin/recommendation/restaurant/edit-restaurant/<?php echo $val['id'];?>"  class="btn btn-warning btn-xs" >
					Edit
					</a>
				    ...
				    <a href="<?php echo base_url();?>/admin/recommendation/restaurant/view-restaurant/<?php echo $val['id'];?>"  class="btn btn-info btn-xs">
					View
					</a>
					</td>
				  </tr>
