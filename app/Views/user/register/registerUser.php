...
<style>
    ...
    .sel-subs.active{
        border: 2px solid #45eaea;
        box-shadow: 0 3px 8px rgb(0, 183, 150);
    }
</style>
                    ...
                    <div class=" main">
                        <div class="row align-items-center" style="margin-right: 0;margin-left: 0;">
                            <div class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 right-side card rounded p-3">
                                <div class="logo_login"><img src="<?php echo $public_url; ?>images/logo.png"
                                                             alt="Company Logo"></div>
                                <h2>Sign-up</h2>
                                <!--Form with header-->
                                <div class="form">

                                    <form action="<?php echo base_url('user/insert-user'); ?>" method="post"
                                          enctype="multipart/form-data" id="registerForm" name="registerForm">
                                        <div class="sign_up">
                                            <div id="tabs">
                                                <div class="row">
                                                    <div class="sign_uptab">
                                                        <div class="tab_contentform">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-12 col-sm-12 form_mobilepadding">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="name" id="name"
                                                                               ...
                                                                               onkeypress="return valueonchange(this.id)">
                                                                ...
                                                                <div class="col-lg-6 col-md-12 col-sm-12 form_mobilepadding">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="email" id="email"
                                                                               ...
                                                                               onblur="return checkEmail('<?php echo site_url(); ?>');"
                                                                               onkeypress="return valueonchange(this.id)"
                                                                               autocomplete="off">
                                                                        <span class="error_class" id="error_email">Please fill email</span>
                                                                        <span class="error_class"
                                                                              id="error_email_valid">Please fill valid email</span>
                                                                        <span style="display:none;color:red"
                                                                              id="error_same_email">Email is already taken</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-12 col-sm-12 form_mobilepadding">
                                                                    <div class="form-group">
                                                                        <label for="Number">Password
                                                                            <span>*</span></label>
                                                                        ...
                                                                        <span class="error_class"
                                                                              id="error_password_field">Please fill Password</span>
                                                                        <span class="error_class"
                                                                              id="error_less_password_field">Please fill Password at least 6 characters</span>
                                                                ...
                                                                <div class="col-lg-6 col-md-12 col-sm-12 form_mobilepadding">
                                                                    <div class="form-group">
                                                                        <label for="Number">Retype Password
                                                                            <span>*</span></label>
                                                                        <input id="rpassword-field" type="password"
                                                                               class="form-control" value=""
                                                                               onkeypress="return valueonchange(this.id)"
                                                                               placeholder="Retype Password">
                                                                        <span class="error_class"
                                                                              id="error_rpassword_field">Please fill password</span>
                                                                        <span class="error_class"
                                                                              id="error_same_password_field">Password and Retype Password should be same</span>
                                                                        <div class="form_icon pwsicon">
                                                                            <span toggle="#rpassword-field"
                                                                                  class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="row pading_rightbx">
                                                                            ...
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 padinlogin form_mobilepadding">
                                                                                ...
                                                                                <input id="callingcode" type="hidden"
                                                                                       name="callingcode" value="+91">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12 col-sm-12">
                                                                    <div class="tacbox">
                                                                        <input id="checkbox" type="checkbox"
                                                                               onchange="valueonchange(this.id)"/>
                                                                        <label for="checkbox"> I agree to the Terms and
                                                                            Conditions<br>By clicking Sign Up, you agree
                                                                            to our <a
								 ...
								 <img src="<?php echo $public_url; ?>images/back_arrow.svg" alt="img">
                                                            ...
                                                            <div class="alreadyaccount alreadyaccount_ipad">Already have
                                                                an account?
                                ...
                                foreach ($subscriptions as $subscription) {
                                    ...
                                    <div id="subs_info_<?=$subscription->id?>" class="subs d-none text-success">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <h1 class=""><?= $subscription->title ?></h1>
                                                <h2>
                                                    <ul>
                                                        <li><b><?= $limits->blog ?></b> Blog posts.</li>
                                                        <li><b><?= $limits->recipe ?></b> Recipe posts.</li>
                                                    </ul>
                                                </h2>
                                            </div>
                                            <div class="col-2">
                                                <h4><b>$</b><?= $subscription->price ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
