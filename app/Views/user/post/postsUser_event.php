...
<main>
  ...
  <div class="profile_middel">
    ...
    ?>
              ...
              <h2 class="blog_user_title"><?php echo $comm['name'];?></h2>
        ...
        ?></a>
          ...
          <div class="read_more"> <a onclick="getSingleEvent('<?php echo $comm['id'];?>')">Read More</a> </div>
        </div>
                ...
                <article class="common-post">
                  <div class="row">
                    <div class="col-sm-12 col-md-12">
                      <div class="common-post-content common-content no_deta_all"> No Event</div>
                    </div>
                  </div>
                </article>
              </li>
