...
<script>
  ...
  $.ajax({
         url: "<?php echo base_url();?>/user/restaurant/show-older-comment",
   type: "POST",
   data:  'id='+id,
   beforeSend : function()
   {
   ...
   success: function(data)
     ...
     error: function(e) 
      ...
      function submitRestudentcomments(){
  ...
  $.ajax({
         url: "<?php echo base_url();?>/user/restaurant/post/insert-comment",
   type: "POST",
...
function hidepopup(){
      $(".modal").modal('hide').css('display','none');
}     
