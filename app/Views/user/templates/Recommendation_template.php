      ...
      <section class="common-section">
        ...
        <div class="blog_sidebar">
          <ul>
            ...
            <li><a href="<?php echo base_url();?>/user/restaurant">RESTAURANTS</a></li>
            <li><a href="<?php echo base_url();?>/user/product">PRODUCT</a></li>
            <li><a href="<?php echo base_url();?>/user/userrecipelist">RECIPES </a></li>
            <li><a href="<?php echo base_url();?>/user/cook">CHEF</a></li>
...
<script>
    ...
    responsive:{
      ...
      function getSingleRestudent(id){
  $.ajax({
    url:'https://hello-vegans.com/user/get-single-restaurant/'+id,
    type:'GET',
