...
// print_r($posts);
  ...
  <div class="profile_middel">
    <div class="container">
     ...
     if(count($blogall_profile)!=0){
  
      foreach($blogall_profile as $comm){
    ...
    ?>
              <div class="one_bx ">
                ...
                <div class="post_images "> <a onclick="getSingleblog('<?php echo $comm['id'];?>')">
        <?php 
		 $videourl='';
        $imageurl='';
		if(!empty($comm['image'])){
   ...
   <?php /*?>     <div class="read_more"> </div><?php */?>
               </div>
