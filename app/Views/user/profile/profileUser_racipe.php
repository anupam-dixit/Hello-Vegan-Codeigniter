  ...
  <div class="profile_middel">
    ...
    ?>
              <div class="one_bx ">
                ...
                <div class="post_images "> <a onclick="getSinglerecipesall('<?php echo $comm['id'];?>')">
        <?php 
		$videourl='';
        $imageurl='';
		if(!empty($comm['image'])){
        ...
        ?></a>
             ...
             <?php /*?><div class="read_more"> <a onclick="getSinglerecipes('<?php echo $comm['id'];?>')">Read More</a> </div><?php */?>
         </div>      
