...
<main class="main-feed">
    ...
    <div class="middle_bg">
      ...
      <?php endif;?>
                <h2><a href="<?php echo base_url();?>/user/event">Blogs</a></h2>
				<h2>Blog Add </h2>
                 
                <!--Form with header-->
                <div class="form">
				
<form action="<?php echo base_url('user/event/insert-blog');?>" method="post" enctype="multipart/form-data" id="eventForm" name="eventForm" onsubmit="return submitEventForm()">                  <div class="form-group">
