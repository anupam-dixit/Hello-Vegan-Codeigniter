    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
           <form action="<?php echo base_url('admin/insertUser');?>" method="post" enctype="multipart/form-data">		  
 		  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
			 ...
			 <div class="col-md-6">
			  ...
			  <label>Profile Image</label>
                <div class="custom-file">
                 ...
                 <label class="custom-file-label" id="profile_image_label" for="profile_image">Profile Image</label>
